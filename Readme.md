...
# Configuration Script – Enevo One - Rev. A

This **Configuration** script is designed for the **Enevo One** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Enevo One Rev. A

Este script de **Configuration** está diseñado para el modelo **Enevo One** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
